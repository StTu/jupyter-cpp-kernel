...
class CppKernel(Kernel):
    ...
    language_info = {'name': 'c',
                     ...
                     'file_extension': '.cpp'}
    banner = "C++ kernel.\n" \
             "Uses g++, compiles in C++20, and creates source code files and executables in temporary folder.\n"
    ...
    def __init__(self, *args, **kwargs):
        ...
        subprocess.call(['g++', filepath, '-std=c++20', '-rdynamic', '-ldl', '-o', self.master_path])
    ...
    def compile_with_gpp(self, source_filename, binary_filename, cflags=None, ldflags=None):
        cflags = ['-std=c++20', '-fPIC', '-shared', '-rdynamic'] + cflags
    ...
    def do_execute(self, code, silent, store_history=True,
        ...
        with self.new_temp_file(suffix='.cpp') as source_file:
            ...
            with self.new_temp_file(suffix='.out') as binary_file:
                p = self.compile_with_gpp(source_file.name, binary_file.name, magics['cppflags'], magics['ldflags'])
